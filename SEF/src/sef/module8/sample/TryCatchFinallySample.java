...
public class TryCatchFinallySample {
    ...
    public void catchMeIfYouCan() {
        ...
        try {
            System.out.println("Let's format string value: " + str.toUpperCase());
        } catch (NullPointerException e) {
            System.out.println("Ooops, variable is not initialized.");
			System.out.println("The details of the problem: " + e);
        }
        finally {
        	System.out.println("This is final message! Yaay!");
		}
